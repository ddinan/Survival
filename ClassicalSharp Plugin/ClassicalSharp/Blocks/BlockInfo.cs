	...
	public partial class BlockInfo {
		...
		public void ResetBlockProps(BlockID id) {
			...
			if (Draw[id] == DrawType.Sprite) {
                ...
                MaxBB[id].X = DefaultSet.WidthX(id);
                MaxBB[id].Z = DefaultSet.WidthZ(id);
            }
            ...
            if (id >= Block.CpeCount) {
                ...
                if(id == Block.Chest1) { SetTex(125, Side.Back, id); }
                if (id == Block.Chest2) { SetTex(125, Side.Front, id); }
                if (id == Block.Chest3) { SetTex(125, Side.Right, id); }
                if (id == Block.Chest4) { SetTex(125, Side.Left, id); }
            }
		}
