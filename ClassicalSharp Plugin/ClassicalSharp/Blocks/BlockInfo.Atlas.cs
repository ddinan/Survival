...
namespace ClassicalSharp {
	...
	public partial class BlockInfo {
		...
		static byte[] topTex = new byte[] { 0,  1,  0,  2, 16,  4, 15, 17, 14, 14, 
			...
			36, 37, 16, 11, 25, 50, 38, 80, 81, 82, 83, 84, 51, 54, 86, 26, 53, 52, 44 , 27 , 45 , 46 , 47 , 61 , 112 , 112 , 112 , 112 , 96 , 96 , 96 , 96 , 97 , 97 , 98 , 98 , 98 , 98 , 62 , 63 , 87 , 88 , 89 , 90 , 116 , 99 , 107 , 107 , 101 , 101 , 91 , 92 , 93 , 94 , 95 , 109 , 110 , 111 , 123 , 123 , 123 , 123};
		static byte[] sideTex = new byte[] { 0,  1,  3,  2, 16,  4, 15, 17, 14, 14, 
			...
			36, 37, 16, 11, 41, 50, 38, 80, 81, 82, 83, 84, 51, 54, 86, 42, 53, 52, 44 , 43 , 45 , 46 , 47 , 61 , 112 , 112 , 112 , 112 , 96 , 96 , 96 , 96 , 97 , 97 , 98 , 98 , 98 , 98 , 62 , 63 , 87 , 88 , 89 , 90 , 116 , 99 , 107 , 107 , 101 , 101  , 91 , 92 , 93 , 94 , 95 , 109 , 110 , 111 , 124 , 124 , 124 , 124};
		static byte[] bottomTex = new byte[] { 0,  1,  2,  2, 16,  4, 15, 17, 14, 14, 
			30, 30, 18, 19, 32, 33, 34, 21, 22, 48, 49, 64, 65, 66, 67, 68, 69, 70, 71, 
			72, 73, 74, 75, 76, 77, 78, 79, 13, 12, 29, 28, 56, 55,  6,  6,  7, 10,  4, 
			36, 37, 16, 11, 57, 50, 38, 80, 81, 82, 83, 84, 51, 54, 86, 58, 53, 52 , 44 , 59 , 45 , 46 , 47 , 61 , 112 , 112 , 112 , 112 ,96 , 96 , 96 , 96 , 97 , 97 , 98 , 98 , 98 , 98, 62 , 63 , 87 , 88 , 89 , 90 , 116 , 99 , 107 , 107 , 101 , 101  , 91 , 92 , 93 , 94 , 95 , 109 , 110 , 111 , 123 , 123 , 123 , 123};
	}
}