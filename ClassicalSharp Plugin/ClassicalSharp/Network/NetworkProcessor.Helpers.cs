...
namespace ClassicalSharp.Network
{
    ...
    public partial class NetworkProcessor : IServerConnection
    {
        ...
        public override void SendInventory(string inv, byte invnb) //++++++
        {
            
            classic.SendInventory(inv, invnb);
           
        }

        public override void SendChests(string inv, byte invnb) //++++++
        {

            classic.SendChests(inv, invnb);
