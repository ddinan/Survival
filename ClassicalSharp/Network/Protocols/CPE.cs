...
namespace ClassicalSharp.Network.Protocols
{
    ...
    public sealed class CPEProtocol : IProtocol
    {
        ...
        void getdamage(int value)
        {
            ...
            game.LocalPlayer.Health -= (short)value; verifyplayerhp();
        ...
        Vector3 CalculVelocityPlayer(Vector3 old)
        {
            Vector3 newvel = old;

            if (pposx < game.LocalPlayer.Position.X)
            {
                newvel.X = 0.15f;
            }
            else
            ...
            if (pposz < game.LocalPlayer.Position.Z)
            {
                newvel.Z = 0.15f;
            }
            else
            ...
            if(game.LocalPlayer.Velocity.Y < 0.1f && game.LocalPlayer.Velocity.Y > -0.1f) { 
            newvel.Y = 0.25f;
            }
            else
            {
            ...
            return newvel;
        } //Calcul Velocity of the player (When Players Hit)
