...
namespace ClassicalSharp.Gui.Screens {
	public sealed class ClassicKeyBindingsScreen : KeyBindingsScreen {
		...
		public override void Init() {
			...
			left[3] = KeyBind.Chat; left[4] = KeyBind.Craft;
			right = new KeyBind[5];
			right[0] = KeyBind.Left; right[1] = KeyBind.Right; right[2] = KeyBind.Inventory;
			right[3] = KeyBind.ToggleFog; right[4] = KeyBind.Sneak;
			leftDesc = new string[] { "Forward", "Back", "Jump", "Chat", "Craft" };
			rightDesc = new string[] { "Left", "Right", "Build", "Toggle fog", "Sneak" };			
	...
	public sealed class NormalKeyBindingsScreen : KeyBindingsScreen {
		...
		public override void Init() {
			...
			left = new KeyBind[6];
			left[0] = KeyBind.Forward; left[1] = KeyBind.Back; left[2] = KeyBind.Jump;
			left[3] = KeyBind.Chat; left[4] = KeyBind.Craft; left[5] = KeyBind.PlayerList;
			right = new KeyBind[6];
			right[0] = KeyBind.Left; right[1] = KeyBind.Right; right[2] = KeyBind.Inventory;
			right[3] = KeyBind.ToggleFog; right[4] = KeyBind.Sneak; right[5] = KeyBind.SendChat;
			leftDesc = new string[] { "Forward", "Back", "Jump", "Chat", "Craft", "Player list" };
			rightDesc = new string[] { "Left", "Right", "Inventory", "Toggle fog", "Sneak", "Send chat" };
