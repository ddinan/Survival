	...
	public sealed class PickingHandler {
		...
		public void PickBlocks(bool cooldown, bool left, bool middle, bool right) {
			...
			if (middle) {
				...
				if (game.CanPick(old)) return;
                if (!inv.CanPlace[block] && game.SelectedPos.Block != Block.Chest1 && game.SelectedPos.Block != Block.Chest2 && game.SelectedPos.Block != Block.Chest3 && game.SelectedPos.Block != Block.Chest4) return;
